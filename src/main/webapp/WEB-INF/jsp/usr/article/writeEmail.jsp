		...
		<form class="gform" method="POST" data-email="yunlinit@gmail.com"
			...
			<table class="write-box table-box-1 mx-auto mt-10" border="1">
				<tbody>
					...
					<tr>
						<th style="font-weight: 600"></th>
						<td><input type="checkbox" checked="checked" class="checkbox checkbox-xs" style="margin-right: 10px;" /> 개인정보
							수집 및 이용에 동의합니다.</td>
					</tr>
					...
					<tr>
						...
						<td style="text-align: left;">
							<button class="writeBtn btn btn-sm" type="submit" value="등록" style="margin-left: 320px;">문의하기</button> <span
							style="float: right;">
...
<script>
        function showSuccessMessage() {
            ...
            document.getElementById("submitBtn").removeAttribute("disabled"); // 버튼 활성화
        }
